 ...
 * @author Sanduni
 */
@WebServlet(name = "AdminRemoveStudent", urlPatterns = {"/AdminRemoveStudent"})
public class AdminRemoveStudent extends HttpServlet {
        ...
        try {
            ...
            for (StudentPreference l1 : l) {
                ...
                if (prefid == 6) {
                    ...
                    switch (pref) {
                        case 1:
                            sp.setStatusByStatus1(s.load(DB.Status.class, 6));
                            break;
                        case 2:
                            sp.setStatusByStatus2(s.load(DB.Status.class, 6));
                            break;
                        case 3:
                            sp.setStatusByStatus3(s.load(DB.Status.class, 6));
                            break;
                        case 4:
                            sp.setStatusByStatus4(s.load(DB.Status.class, 6));
                            break;
                    }
